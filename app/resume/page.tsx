...
export const metadata: Metadata = {
  ...
  description:
    "Professional snapshot for Rishwari Ranjan — software engineer building patient-facing AI and the systems underneath it."
};
...
export default function ResumePage() {
  ...
  return (
    <Section reveal={false} spacing="hero" containerSize="reading">
      ...
      <section className="mt-14">
        <h2 className="chapter-label text-left">Education + Research</h2>
        ...
        {educationResearch.credentials.trim().length > 0 ? (
          <p className="mt-6 font-editorial text-base italic text-mutedFg">
            {educationResearch.credentials}
          </p>
        ) : null}
      </section>
